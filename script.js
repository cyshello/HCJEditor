...
//////////////////// Element Control ///////////////////////
    function resize_percent(obj){
        ...
        var rw = window.getComputedStyle(document.querySelector(".resultpage"), null).getPropertyValue('width').replace('px','');
        var rh = window.getComputedStyle(document.querySelector(".resultpage"), null).getPropertyValue('height').replace('px','');
        var flag = false;
        ...
        if(ct.indexOf('px') != -1){
            ...
            document.querySelector(obj).offsetTop = String(t_percent)+"%";
            document.querySelector(obj).offsetLeft = String(l_percent)+"%";
